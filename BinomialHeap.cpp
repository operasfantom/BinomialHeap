...
        switch (type)
        {
        case 0: {//add element V in heap NUMBER
            index++;
            int v, number;
            scanf("%d%d", &number, &v);
            val.push_back(v);
...
            break;
        }
        case 1: {//pull over all elments from heap NUM1 to NUM2
            int num1, num2;
            scanf("%d%d", &num1, &num2);
...
            break;
        }
        case 2: {//remove element which index is OP
            int op;
            scanf("%d", &op);
            remove(what_tree[op]);
            break;
        }
        case 3: {//assign value V to element OP
            int op, v;
            scanf("%d%d", &op, &v);
...
            break;
        }
        case 4: {//print minimum in heap NUM
            int num;
            scanf("%d", &num);
...
            break;
        }
        case 5: {//remove minimum from heap NUM
            int num;
            scanf("%d", &num);
